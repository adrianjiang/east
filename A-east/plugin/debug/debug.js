...
1. 屏蔽了对console.log的覆盖
2. 将层级设为19891015，以在layer弹出层之上
...
(function(WIN, DOC) {
  ...
  Debug = (function() {
    ...
    parentCss = ["-webkit-overflow-scrolling:touch", "overflow:auto", "line-height:1.5", "z-index:19891015", "position:fixed", "left:0", "top:0", "font-size:11px", "background:rgba(0,0,0,.8)", "color:#fff", "width:100%", "padding-bottom:" + parentBottom + "px", "max-height:100%"].concat(publicCss);
